c--subroutine dlsode (f, neq, y, t, tout, itol, rtol, atol, itask, istate, iopt, rwork, lrw, iwork, liw, jac, mf)
*DECK DLSODE
...
C----------------------- END OF SUBROUTINE DLSODE ----------------------
      END
c--- subroutine intdy (t, k, yh, nyh, dky, iflag)
*DECK DINTDY
...
C----------------------- END OF SUBROUTINE DSTODE ----------------------
      END
c--- subroutine cfode (meth, elco, tesco)
*DECK DCFODE
...
C----------------------- END OF SUBROUTINE DCFODE ----------------------
      END
c--- subroutine prepj (neq, y, yh, nyh, ewt, ftem, savf, wm, iwm,
*DECK DPREPJ
...
C----------------------- END OF SUBROUTINE DPREPJ ----------------------
      END
c--- subroutine solsy (wm, iwm, x, tem)
*DECK DSOLSY
...
C----------------------- END OF SUBROUTINE DSOLSY ----------------------
      END
c--- subroutine ewset (n, itol, rtol, atol, ycur, ewt)
*DECK DEWSET
...
C----------------------- END OF SUBROUTINE DEWSET ----------------------
      END
c--- subroutine srcom (rsav, isav, job)
*DECK DSRCOM
